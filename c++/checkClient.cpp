...
int initClient::recFile(char* filename)
{
    
	printf("Connecting...\n");
	memset(this->chunk, '0',sizeof(this->chunk));
...
{
    initClient cl("127.0.0.1");
    cl.recFile("/home/shiza/files/craa");
